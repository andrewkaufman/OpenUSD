...
std::vector<UsdPrim> UsdPhysicsRigidBodyAPI::GetCollisionPrims() const
{
    ...
    // Prune the subtree rooted at any nested rigid body (those colliders
    // belong to a different body), and skip colliders whose collision is
    // disabled since they take no part in simulation.
